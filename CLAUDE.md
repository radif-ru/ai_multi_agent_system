...
Поведенческие гайдлайны для LLM-агента, чтобы сократить типовые ошибки в коде. Перевод оригинального [CLAUDE.md](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CLAUDE.md).
