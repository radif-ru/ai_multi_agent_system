...
│   ├── process.md            # свод правил и процесса: легенды, шаблоны, §1–§13
...
| `_board/process.md` | Свод правил процесса: легенды, правила спринтов и задач, шаблоны, пошаговый алгоритм (§1–§13). |
