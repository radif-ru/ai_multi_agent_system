...
## Этап 3. Capability graph для multi-agent
...
## Этап 13. Hot-reload скиллов и промптов
...
## Этап 14. Per-skill / per-task memory
...
**Зависит от:** Спринта 07 (multi-agent: Planner + Critic), уже закрыт — см. `_docs/multi-agent.md`.

## Этап 15. Файловые входы — добор
