...
Документ описывает работу Executor — единственного агента MVP. Future-документ для Planner / Critic — отдельный, появится в спринте мульти-агента (см. `roadmap.md` Этап 3).
