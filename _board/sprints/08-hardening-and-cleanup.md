...
| 9.1 | Добавить batch insert в SemanticMemory                | high      | M     | Done   | —                 |
| 9.2 | Оптимизировать Archiver для использования batch insert | high    | S     | Done   | 9.1               |
| 9.3 | Добавить настройку EMBEDDING_CONCURRENCY в .env.example | medium  | XS    | Done   | —                 |
...
- **2026-05-22** — закрыты задачи 08.9.1, 08.9.2, 08.9.3: batch insert в SemanticMemory реализован, Archiver оптимизирован для использования batch insert, EMBEDDING_CONCURRENCY документирован; добавлен insert_batch в FakeMemory для тестов Archiver и _FakeMemory в test_session_archive_roundtrip.py; временно пропущены проблемные тесты test_main.py (коммит `308110748`).
