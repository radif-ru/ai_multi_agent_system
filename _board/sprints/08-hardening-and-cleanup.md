...
| 9.2 | Оптимизировать Archiver для использования batch insert | high    | S     | Progress | 9.1            |
...
- **2026-05-22** — закрыта задача 08.9.1: добавлен метод insert_batch в SemanticMemory; добавлены тесты; обновлена документация _docs/memory.md (коммит `3c9e4782` feat).
- **2026-05-22** — начата задача 08.9.2: оптимизация Archiver для использования batch insert.
