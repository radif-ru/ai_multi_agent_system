...
- [ ] `FileIdMapper` работает поверх `dialog_journal`; существующие тесты `tests/security/test_file_id_mapper.py` обновлены под новую БД.
- [ ] В коде нет упоминаний `file_contexts.db` (кроме описания миграции).
- [ ] `_docs/security.md` и `_docs/memory.md` синхронизированы.
...
| 3-bis.3 | `FileIdMapper` — на `dialog_journal`              | high      | S     | Progress | 3-bis.2  |
| 3-bis.4 | Отказ от `.ocr.txt` на диске                      | medium    | XS    | ToDo   | —          |
